package sec2;
//람다식 : 함수 및 메소드를 간소화한 표현식 || Phython이나 JavaScript에서는 Arrow Function 이라고 부른다
//자바의 기본적인 람다식 정의 방법 -> 함수적 인터페이스(Functional Interface)
//함수적 인터페이스는 @functionalInterface 로 정의, ★메소드는 오로지 하나만 가져야한다.
